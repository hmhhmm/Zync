...
import { AlertTriangle, BadgeCheck, CheckCircle, Clock, Loader2, MapPin, Shield, TrendingUp, WifiOff } from 'lucide-react';
  ...
  return (
    <div className="terminal" id="zone-reasoning-panel">
      <div className="terminal__topbar">
        ...
        <span className="font-mono text-[10px] text-white/40 ml-2 flex-1">glm-4-plus · zone-prioritiser · agent-06</span>
      ...
      <div className="grid grid-cols-1 2xl:grid-cols-5 gap-6">
        ...
        <div className="2xl:col-span-3 grid gap-4" id="zone-leaderboard">
          ...
          {zones.map((zone, idx) => {
            ...
            return (
              ...
              >
                {/* Score bar at top */}
                <span className="zone-card__score-bar" style={{ width: `${zone.score}%` }} aria-hidden />
                ...
                {zone.reasoning_bm && (
                  <details className="mt-2">
                    <summary className="mono-meta cursor-pointer text-white/40 hover:text-white/60 text-[9.5px]">Ulasan BM</summary>
                    <p className="mt-1.5 text-[12px] text-white/60 leading-relaxed">{zone.reasoning_bm}</p>
                  </details>
                )}
              </article>
            );
        ...
        <div className="2xl:col-span-2 grid gap-5">
          ...
          <div className="panel-inset--accent" id="sovereign-summary" style={{ padding: '24px' }}>
            ...
            <div className="inline-flex items-center gap-2 chip chip--accent mt-3" style={{ fontSize: 10 }}>
              <BadgeCheck size={11} /> Bahasa Malaysia Brief
            </div>
          ...
          <div className="panel-inset p-6" id="methodology-card">
            ...
            <p className="text-[11.5px] text-white/50 leading-relaxed mb-5">
          ...
          <div className="panel-inset p-6" id="validation-card">
            ...
            <p className="text-[11.5px] text-white/55 leading-relaxed mb-5">
              Five published benchmarks (DOSM, AELB, MOSTI) run against the live backend to prove the recommendation engine is grounded — not hallucinated.
            </p>
            <button
            ...
            {validation && (
              <div className="mt-5 pt-4 border-t border-white/6 grid gap-3">
                ...
                {validation.results?.map((r) => (
                  <div key={r.test_id} className="panel-inset--soft flex items-center justify-between gap-3 px-3 py-2.5">
                    ...
                    <span className={`font-mono text-[10px] px-2 py-0.5 rounded-md border shrink-0 ${
                      r.status === 'pass' ? 'border-green-500/40 text-green-300 bg-green-500/10'
                      : r.status === 'edge_case' ? 'border-indigo-400/40 text-indigo-200 bg-indigo-500/10'
